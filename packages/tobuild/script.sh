...
packages=${*:-lokinet firefox-userchromejs firefox-keyconfig firefox-vimfx firefox-ytarb firefox-dark-reader firefox-sponsorblock lsb-release wlroots wf-config wayfire wlogout waybar wdisplays clapper neo}
pgpkeys=(
