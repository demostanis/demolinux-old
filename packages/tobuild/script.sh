...
packages=${*:-gimmeasearx lokinet firefox-userchromejs firefox-keyconfig firefox-vimfx firefox-ytarb firefox-dark-reader firefox-sponsorblock lsb-release wlroots wf-config wayfire wlogout waybar wdisplays emmet-cli neo kakoune up kampliment}
pgpkeys=(
